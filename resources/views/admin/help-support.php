          ...
          <div class="card">
            ...
            <div class="card-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php 
                    $query=$mysqli->query("SELECT * FROM help");
                    $help_res=$query->fetch_assoc();
                  ?>
                <tr>
                  <td><?php echo $help_res['help_heading'];?></td>
                  <td><?php echo $help_res['help_description'];?></td>
                  <td>
                       <a href="edithelp-support.php?id=<?php echo base64_encode($help_res['help_id']);?>">
