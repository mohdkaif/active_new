<?php
 ...
 if($_SESSION['adminUName']=='')
 {
  ...
  $res=$mysqli->query("UPDATE `help` SET `help_heading`='".addslashes($_POST['help_heading'])."',`help_description`='".addslashes($_POST['help_description'])."' WHERE `help_id`='$id'");
  if($res)
   {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <?php if(isset($msg)){echo $msg;}?>
                 <?php  
                     $query=$mysqli->query("SELECT * FROM help WHERE help_id='$id'");
                     $help_res=$query->fetch_assoc();
                   ?>
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                <form  method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="help_heading" value="<?php echo $help_res['help_heading'];?>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Description</label>
                        <div class="col-sm-10">
                           <textarea id="editor1" name="help_description" rows="10" cols="80"><?php echo $help_res['help_description'];?></textarea>
                        </div>
                      </div>
