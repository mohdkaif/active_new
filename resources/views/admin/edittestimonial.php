<?php
 ...
 global $msg;
  ...
  //echo $image_file;exit;
   ...
   $res=$mysqli->query("UPDATE `testimonial` SET `image`='".$image_file."',`testimonial_name`='".addslashes($_POST['testimonial_name'])."',`testimonial_designation`='".addslashes($_POST['testimonial_designation'])."',`testimonial_description`='".addslashes($_POST['testimonial_description'])."' WHERE `testimonial_id`='$id'");
  }     
  if($res)
  {
  $msg='<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">X</button><strong>Well done!</strong> Image succesfully Saved</div>';
   ...
   elseif($_POST['testimonial_name']<>'')
   {
   $res=$mysqli->query("UPDATE `testimonial` SET `testimonial_name`='".addslashes($_POST['testimonial_name'])."',`testimonial_designation`='".addslashes($_POST['testimonial_designation'])."',`testimonial_description`='".addslashes($_POST['testimonial_description'])."' WHERE `testimonial_id`='$id'");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Destimonial</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Destimonial</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <?php if(isset($msg)){echo $msg;}?>
                  <?php  
                     ...
                     $testimonial_res=$query->fetch_assoc();
                   ?>
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                <form  method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                         <input type="file" name="image" onChange="readURL(this,1);" required">
                         <p class="help-block">You can upload only png and jpg or jpeg.</p>
                  <img id="image1" height="200px;" width="250px;" src="images/<?php echo $testimonial_res['image'];?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Name</label>
                        <div class="col-sm-10">
                           <input type="text" name="testimonial_name" value="<?php echo $testimonial_res['testimonial_name'];?>" class="form-control">
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Designation</label>
                        <div class="col-sm-10">
                           <input type="text" name="testimonial_designation" value="<?php echo $testimonial_res['testimonial_designation'];?>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Description</label>
                        <div class="col-sm-10">
                           <textarea id="editor1" name="testimonial_description" rows="10" cols="80"><?php echo $testimonial_res['testimonial_description'];?></textarea>
                        </div>
                      </div>
