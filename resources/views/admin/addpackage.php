 ...
 if($_SESSION['adminUName']==''){
  ...
  if(isset($_POST['submit']))
  {
    ...
    if($_FILES['image']['name']<>''){
        ...
        $res=$mysqli->query("INSERT INTO `package`(`image`, `package_plan`, `package_price`, `package_description`) VALUES ('".$image_file."','".addslashes($_POST['package_plan'])."','".addslashes($_POST['package_price'])."','".addslashes($_POST['package_description'])."')");
      }
   }    
    if($res)
    {
                ...
                <form  method="post" enctype="multipart/form-data">
                  ...
                  <img id="image1" height="200px;" width="250px;">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <input type="text" name="package_plan" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <textarea id="editor1" name="package_description" rows="10" cols="80"></textarea>
                        </div>
                      </div>
