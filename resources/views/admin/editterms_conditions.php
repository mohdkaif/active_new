<?php
 ...
 if($_SESSION['adminUName']=='')
 {
  ...
  $res=$mysqli->query("UPDATE `terms_conditions` SET `terms_conditions_heading`='".addslashes($_POST['terms_conditions_heading'])."',`terms_conditions_description`='".addslashes($_POST['terms_conditions_description'])."' WHERE `terms_conditions_id`='$id'");
  if($res)
   {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <?php if(isset($msg)){echo $msg;}?>
                 <?php  
                     $query=$mysqli->query("SELECT * FROM terms_conditions WHERE terms_conditions_id='$id'");
                     $terms_conditions_res=$query->fetch_assoc();
                   ?>
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                <form  method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="terms_conditions_heading" value="<?php echo $terms_conditions_res['terms_conditions_heading'];?>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Description</label>
                        <div class="col-sm-10">
                           <textarea id="editor1" name="terms_conditions_description" rows="10" cols="80"><?php echo $terms_conditions_res['terms_conditions_description'];?></textarea>
                        </div>
                      </div>
