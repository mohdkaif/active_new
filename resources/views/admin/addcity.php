...
session_start();
 if($_SESSION['adminUName']==''){
  ...
  if(isset($_POST['submit']))
  {
    ...
    $res=$mysqli->query("INSERT INTO `city`(`state_id`,`city_name`) VALUES ('".addslashes($_POST['state_id'])."','".addslashes($_POST['city_name'])."')");
                ...
                <form  method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="state_id">
                      ...
                      <?php $state_query=$mysqli->query("select * from state");
                       while($state_res=$state_query->fetch_assoc())
                        {?>       
                      <option value="<?php echo $state_res['state_id']; ?>"><?php echo $state_res['state_name']; ?>
                      </option>                   
                       <?php } ?> 
                    </select>
                  </div>
