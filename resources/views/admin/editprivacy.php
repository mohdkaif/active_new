<?php
 ...
 if($_SESSION['adminUName']=='')
 {
  ...
  $res=$mysqli->query("UPDATE `privacy` SET `privacy_heading`='".addslashes($_POST['privacy_heading'])."',`privacy_description`='".addslashes($_POST['privacy_description'])."' WHERE `privacy_id`='$id'");
  if($res)
   {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <?php if(isset($msg)){echo $msg;}?>
                 <?php  
                     $query=$mysqli->query("SELECT * FROM privacy WHERE privacy_id='$id'");
                     $privacy_res=$query->fetch_assoc();
                   ?>
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                <form  method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="privacy_heading" value="<?php echo $privacy_res['privacy_heading'];?>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Description</label>
                        <div class="col-sm-10">
                           <textarea id="editor1" name="privacy_description" rows="10" cols="80"><?php echo $privacy_res['privacy_description'];?></textarea>
                        </div>
                      </div>
