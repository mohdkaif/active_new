<?php
 ...
 $res='';
    ...
    $res=$mysqli->query("UPDATE `qualifications` SET `qualification_name`='".addslashes($_POST['qualification_name'])."',`qualification_year`='".addslashes($_POST['qualification_year'])."',`service_provider_id`='".$_SESSION['service_provider_id']."' WHERE `qualification_id`='$id'");
    if($res)
    {
