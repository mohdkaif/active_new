<?php
 ...
 global $msg;
  ...
  $res=$mysqli->query("UPDATE `state` SET `state_name`='".addslashes($_POST['state_name'])."' WHERE `state_id`='$id'");
   if($res)
   {
            ...
            <div class="card-body">
                <form  method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <input type="text" name="state_name" value="<?php echo $state_res['state_name'];?>" class="form-control">
                        </div>
                      </div>
