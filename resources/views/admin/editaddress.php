<?php
 ...
 if($_SESSION['adminUName']=='')
 {
  ...
  $res=$mysqli->query("UPDATE `address` SET `location`='".addslashes($_POST['location'])."',`phone`='".addslashes($_POST['phone'])."',`email`='".addslashes($_POST['email'])."' WHERE `address_id`='$id'");
  if($res)
   {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <?php if(isset($msg)){echo $msg;}?>
                 <?php  
                     $query=$mysqli->query("SELECT * FROM address WHERE address_id='$id'");
                     $address_res=$query->fetch_assoc();
                   ?>
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                <form  method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="phone" value="<?php echo $address_res['phone'];?>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Email</label>
                        <div class="col-sm-10">
                            <input type="text" name="email" value="<?php echo $address_res['email'];?>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Address</label>
                        <div class="col-sm-10">
                            <input type="text" name="location" value="<?php echo $address_res['location'];?>" class="form-control">
                        </div>
                      </div>
