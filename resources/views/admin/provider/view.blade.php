          ...
          <div class="card-body">
              <form  method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <p class="help-block"><strong>Phone :</strong> {{!empty($user['mobile'])?$user['mobile']:''}}</p>
                    </div>
                    
                    <div class="form-group">
                      <p class="help-block"><strong>Date of birth :</strong> <?php echo $user['date_of_birth'];?></p>
                    </div>
                    ...
                    <div class="form-group">
                      <p class="help-block"><strong>City:</strong></p>
                      <p> {{!empty($user['city_details']['name'])?$user['city_details']['name']:''}}</p>
                    </div>
