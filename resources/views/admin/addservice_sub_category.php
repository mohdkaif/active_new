...
session_start();
 if($_SESSION['adminUName']==''){
  ...
  if(isset($_POST['submit']))
  {
    ...
    $res=$mysqli->query("INSERT INTO `service_sub_category`(`service_category_id`,`service_sub_category_name`) VALUES ('".addslashes($_POST['service_category_id'])."','".addslashes($_POST['service_sub_category_name'])."')");
                ...
                <form  method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="service_category_id">
                      ...
                      <?php $category_query=$mysqli->query("select * from service_category");
                       while($service_category_res=$category_query->fetch_assoc())
                        {?>       
                      <option value="<?php echo $service_category_res['service_category_id']; ?>"><?php echo $service_category_res['service_category_name']; ?>
                      </option>                   
                       <?php } ?> 
                    </select>
                  </div>
