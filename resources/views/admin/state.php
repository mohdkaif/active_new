...
<head>
 ...
 <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <script>
    ...
    if (x)
      {
         $.ajax({type:'POST',url:'deletestate.php',data:{id:id},success:function(result){
     if(result=='yes')
     {
     // alert(result);
          ...
          <div class="card">
            ...
            <div class="card-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                   <?php  
                     $query=$mysqli->query("SELECT * FROM state");
                      if($query->num_rows > 0){
                      while($state_res=$query->fetch_assoc())
                      {
              
                   ?>

                    <tr class="odd gradeX" id="sessiondiv<?php echo $state_res['state_id'];?>">
                        <td><?php echo $state_res['state_name'];?></td>
                         
                        <td>
                           
                            <a href="editstate.php?id=<?php echo base64_encode($state_res['state_id']);?>">
                                <button class="btn btn-info btn-flat"><i class="fa fa-edit"></i>Edit</button>
                            </a>
                             <a href="javascript:void(o);" onClick="deletestate(<?php echo $state_res['state_id'];?>);">
