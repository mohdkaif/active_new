            ...
            <div class="card-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  ?>
                <tr>
                  <td><?php echo $address_res['phone'];?></td>
                  <td><?php echo $address_res['email'];?></td>
                  <td><?php echo $address_res['location'];?></td>
                  <td>
                       <a href="editaddress.php?id=<?php echo base64_encode($address_res['address_id']);?>">
