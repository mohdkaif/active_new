<?php
 ...
 global $msg;
  ...
  //echo $image_file;exit;
   ...
   $res=$mysqli->query("UPDATE `package` SET `image`='".$image_file."',`package_plan`='".addslashes($_POST['package_plan'])."',`package_price`='".addslashes($_POST['package_price'])."',`package_description`='".addslashes($_POST['package_description'])."' WHERE `package_id`='$id'");
  }     
  if($res)
  {
  $msg='<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">X</button><strong>Well done!</strong> Image succesfully Saved</div>';
   ...
   elseif($_POST['package_plan']<>'')
   {
   $res=$mysqli->query("UPDATE `package` SET `package_plan`='".addslashes($_POST['package_plan'])."',`package_price`='".addslashes($_POST['package_price'])."',`package_description`='".addslashes($_POST['package_description'])."' WHERE `package_id`='$id'");
          ...
          <div class="card card-info card-outline">
            ...
            <div class="card-body">
                <form  method="post" enctype="multipart/form-data">
                  ...
                  <img id="image1" height="200px;" width="250px;" src="images/<?php echo $package_res['image'];?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Plan</label>
                        <div class="col-sm-10">
                           <input type="text" name="package_plan" value="<?php echo $package_res['package_plan'];?>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Price</label>
                        <div class="col-sm-10">
                           <input type="text" name="package_price" value="<?php echo $package_res['package_price'];?>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Description</label>
                        <div class="col-sm-10">
                           <textarea id="editor1" name="package_description" rows="10" cols="80"><?php echo $package_res['package_description'];?></textarea>
                        </div>
                      </div>
