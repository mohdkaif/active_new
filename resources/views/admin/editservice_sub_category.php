<?php
 ...
 global $msg;
  ...
  $res=$mysqli->query("UPDATE `service_sub_category` SET `service_category_id`='".addslashes($_POST['service_category_id'])."',`service_sub_category_name`='".addslashes($_POST['service_sub_category_name'])."' WHERE `service_sub_category_id`='$id'");
   if($res)
   {
...
<body class="hold-transition sidebar-mini">
    ...
    <section class="content">
      <?php if(isset($msg)){echo $msg;}?>
                  <?php  
                     ...
                     $sub_category_res=$query->fetch_assoc();
  ...
  <?php $category_query=$mysqli->query("select * from service_category where service_category_id='".$sub_category_res['service_category_id']."'");
                       while($category_res=$category_query->fetch_assoc())
                        {?>       
                      <option <?php if($category_res['service_category_id']==$sub_category_res['service_category_id']){ ?> selected <?php }?> value="<?php echo $category_res['service_category_id']; ?>"><?php echo $category_res['service_category_name']; ?>
                      </option>                   
                       <?php } ?> 
                    </select>
                  </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <input type="text" name="service_sub_category_name" value="<?php echo $sub_category_res['service_sub_category_name'];?>" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                          ...
                          <a href="service_sub_category.php">
