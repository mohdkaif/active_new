<?php
 ...
 global $msg;
  ...
  $res=$mysqli->query("UPDATE `city` SET `state_id`='".addslashes($_POST['state_id'])."',`city_name`='".addslashes($_POST['city_name'])."' WHERE `city_id`='$id'");
   if($res)
   {
    ...
    <section class="content">
      <?php if(isset($msg)){echo $msg;}?>
                  <?php  
                     ...
                     $city_res=$query->fetch_assoc();
              $state_query=$mysqli->query("SELECT * FROM state WHERE state_id='".$state_res['state_id']."'");
      ...
      <?php $state_query=$mysqli->query("select * from state where state_id='".$city_res['state_id']."'");
                       while($state_res=$city_query->fetch_assoc())
                        {?>       
                      <option <?php if($state_res['state_id']==$city_res['state_id']){ ?> selected <?php }?> value="<?php echo $state_res['state_id']; ?>"><?php echo $city_res['state_name']; ?>
                      </option>                   
                       <?php } ?> 
                    </select>
                  </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <input type="text" name="city_name" value="<?php echo $state_res['city_name'];?>" class="form-control" readonly>
                        </div>
                      </div>
