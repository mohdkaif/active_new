 ...
 if($_SESSION['adminUName']==''){
  ...
  if(isset($_POST['submit']))
  {
    $res='';
        ...
        $res=$mysqli->query("INSERT INTO `qualifications`(`qualification_name`,`qualification_year`,`service_provider_id`) VALUES ('".addslashes($_POST['qualification_name'])."','".addslashes($_POST['qualification_year'])."','".$_SESSION['service_provider_id']."')");
            ...
            <div class="card-body">
                <form  method="post" enctype="multipart/form-data">
                  <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <select class="form-control" name="qualification_name"  required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <select class="form-control" name="qualification_year"  required>
