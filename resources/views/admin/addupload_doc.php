            ...
            <div class="card-body">
                <form  method="post" enctype="multipart/form-data">
                  <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <select class="form-control" name="doc_name" onChange="get_city(this.value);" required>
                    ...
                    <option value="Police Verification">Police Verification</option>
                      ...
                      <div class="form-group">
                        <label class="col-sm-6 control-label">Document File</label>
                        <div class="col-sm-6">
                         <input type="file" name="doc_file" onChange="readURL(this,1);" required">
                         <p class="help-block">You can upload only docx doc pdf png and jpg or jpeg.</p>
                         
                          <a href="upload_doc/<?php echo $upload_doc_res['doc_file'];?>" download>
                              <img src="upload_doc/images/download.jpg" id="image1" height="200px;" width="250px;">
                          </a>
