<?php
 ...
 global $msg;
  ...
  //echo "UPDATE `slider` SET `image`='".$image_file."',`title`='".addslashes($_POST['title'])."' WHERE `sliderid`='$id'";exit;
   $res=$mysqli->query("UPDATE `indexslider` SET `image`='".$image_file."',`heading`='".addslashes($_POST['heading'])."',`description`='".addslashes($_POST['description'])."' WHERE `indexsliderId`='$id'");
  }     
  if($res)
  {
  $msg='<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">X</button><strong>Well done!</strong> Image succesfully Saved</div>';
   ...
   elseif($_POST['heading']<>'')
   {
   $res=$mysqli->query("UPDATE `indexslider` SET `heading`='".addslashes($_POST['heading'])."',`description`='".addslashes($_POST['description'])."' WHERE `indexsliderId`='$id'");
          ...
          <div class="card card-info card-outline">
            ...
            <div class="card-body">
                <form  method="post" enctype="multipart/form-data">
                  ...
                  <img id="image1" height="200px;" width="250px;" src="images/<?php echo $slider_res['image'];?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Heading</label>
                        <div class="col-sm-10">
                           <input type="text" name="heading" value="<?php echo $slider_res['heading'];?>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Description</label>
                        <div class="col-sm-10">
                           <textarea id="editor1" name="description" rows="10" cols="80"><?php echo $slider_res['description'];?></textarea>
                        </div>
                      </div>
