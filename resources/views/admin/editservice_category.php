<?php
 ...
 global $msg;
  ...
  $res=$mysqli->query("UPDATE `service_category` SET `service_category_name`='".addslashes($_POST['service_category_name'])."' WHERE `service_category_id`='$id'");
   if($res)
   {
    ...
    <section class="content">
      <?php if(isset($msg)){echo $msg;}?>
                  <?php  
                     ...
                     $service_category_res=$query->fetch_assoc();
                   ?>
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                <form  method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <input type="text" name="service_category_name" value="<?php echo $service_category_res['service_category_name'];?>" class="form-control">
                        </div>
                      </div>
