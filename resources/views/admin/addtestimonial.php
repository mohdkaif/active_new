 ...
 if($_SESSION['adminUName']==''){
  ...
  if(isset($_POST['submit']))
  {
    ...
    if($_FILES['image']['name']<>''){
        ...
        $res=$mysqli->query("INSERT INTO `testimonial`(`image`,`testimonial_name`,`testimonial_designation`,`testimonial_description`) VALUES ('".$image_file."','".addslashes($_POST['testimonial_name'])."','".addslashes($_POST['testimonial_designation'])."','".addslashes($_POST['testimonial_description'])."')");
      }
   }    
    if($res)
    {
                ...
                <form  method="post" enctype="multipart/form-data">
                  ...
                  <img id="image1" height="200px;" width="250px;">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <textarea id="editor1" name="testimonial_description" rows="10" cols="80"></textarea>
                        </div>
                      </div>
