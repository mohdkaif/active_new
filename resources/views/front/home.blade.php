            ...
            <section id="fullSlider" class="carousel slide fullscreenSlider" data-ride="carousel">
               ...
               <div class="carousel-inner">
                  <div class="item active" style="background-image: url('assets/images/main-slider/eight-1.jpg');">
                  </div>
                  <!-- end of item -->
                  <div class="item" style="background-image: url('assets/images/main-slider/Child-education.jpg');">
                  </div>
                  <!-- end of item -->
                  <div class="item " style="background-image: url('assets/images/main-slider/2.jpg');">
                  </div>
                  <!-- end of item -->
                  <div class="item " style="background-image: url('assets/images/main-slider/index.jpg');">
                  </div>
                  <!-- end of item -->
               </div>
               <!-- Carousel controls -->
                  ...
                  <div class="row clearfix">
                     ...
                     <div class="info-block ">
                        <div class="inner-box clearfix">
                           <div class="icon-box"><img src="{{url('assets/images/icon1.png')}}" alt=""></div>
                     ...
                     <div class="info-block ">
                        <div class="inner-box clearfix">
                           <div class="icon-box"><img src="{{url('assets/images/icon2.png')}}" alt=""></div>
                     ...
                     <div class="info-block ">
                        <div class="inner-box clearfix">
                           <div class="icon-box"><img src="{{url('assets/images/icon3.png')}}" alt=""></div>
                           <h3><a href="#" style="text-align:center">PACKAGES</a></h3>
                        </div>
                     </div>
                     <div class="info-block ">
                        <div class="inner-box clearfix">
                           <div class="icon-box"><img src="{{url('assets/images/icon4.png')}}" alt=""></div>
                  ...
                  <div class="row clearfix">
                     <div id="news-slider" class="owl-carousel4">
                        ...
                        <div class="staff-block">
                           <div class="inner-box">
                              <div class="image-box wow fadeInDown animated" data-wow-duration="1500ms" data-wow-delay="0ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInDown;"><a href="#"><img src="{{url('assets/images/teacher1.jpg')}}" alt=""></a></div>
                              <div class="info-box">
                        ...
                        <div class="staff-block">
                           <div class="inner-box">
                              <div class="image-box wow fadeInDown animated" data-wow-duration="1500ms" data-wow-delay="300ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 300ms; animation-name: fadeInDown;"><a href="#"><img src="{{url('assets/images/teacher2.jpg')}}" alt="" class="img-rounded"></a></div>
                              <div class="info-box">
                        ...
                        <div class="staff-block ">
                           <div class="inner-box">
                              <div class="image-box wow fadeInDown animated" data-wow-duration="1500ms" data-wow-delay="600ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 600ms; animation-name: fadeInDown;"><a href="#"><img src="{{url('assets/images/teacher3.jpg')}}" alt="" ></a></div>
                              <div class="info-box">
                        ...
                        <div class="staff-block">
                           <div class="inner-box">
                              <div class="image-box wow fadeInDown animated" data-wow-duration="1500ms" data-wow-delay="600ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 600ms; animation-name: fadeInDown;"><a href="#"><img src="{{url('assets/images/teacher4.jpg')}}" alt=""></a></div>
                              <div class="info-box">
            ...
            <div class="auto-container">
               ...
               <div class="filter-list row clearfix" id="MixItUp620B5A">
                  ...
                  <div class="gallery-item mix all campus video " style="display: inline-block;">
                     <div class="inner-box">
                        <figure class="image-box">
                           <img src="{{url('assets/images/gallery/ctagories1.jpg')}}" alt="">
                           <!--Overlay Box-->
                    ...
                    <div class="gallery-item mix all campus video " style="display: inline-block;">
                     <div class="inner-box">
                        <figure class="image-box">
                           <img src="{{url('assets/images/gallery/ctagories2.jpg')}}" alt="">
                           <!--Overlay Box-->
                           <div class="caption-box clearfix">
                              <div class="title">
                                 <h3><a href="event.php">Cricket</a></h3>
                  ...
                  <div class="gallery-item mix all activity video " style="display: inline-block;">
                     <div class="inner-box">
                        <figure class="image-box">
                           <img src="{{url('assets/images/gallery/ctagories3.jpg')}}" alt="">
                           <!--Overlay Box-->
                           <div class="caption-box clearfix">
                              <div class="title">
                                   <h3><a href="event.php">Cricket</a></h3>
                  ...
                  <div class="gallery-item mix all campus photos " style="display: inline-block;">
                     <div class="inner-box">
                        <figure class="image-box">
                           <img src="{{url('assets/images/gallery/ctagories4.jpg')}}" alt="">
                           <!--Overlay Box-->
                          <div class="caption-box clearfix">
                              <div class="title">
                                 <h3><a href="event.php">Cricket</a></h3>
            ...
            <div class="auto-container">
               ...
               <div class="filter-list row clearfix" id="MixItUp620B5A">
                  ...
                  <div class="gallery1-item mix all campus video " style="display: inline-block;">
                     <div class="inner-box">
                        <figure class="image-box">
                           <img src="{{url('assets/images/gallery/gallary1.png')}}" alt="">
                           <!--Overlay Box-->
                           <div class="caption-box clearfix">
                              <div class="title">
                                   <h3>
                  ...
                  <div class="gallery1-item mix all activity video " style="display: inline-block;">
                     <div class="inner-box">
                        <figure class="image-box">
                           <img src="{{url('assets/images/gallery/gallary2.png')}}" alt="">
                           <!--Overlay Box-->
                           <div class="caption-box clearfix">
                              <div class="title">
                                <h3>
                  ...
                  <div class="gallery1-item mix all campus photos " style="display: inline-block;">
                     <div class="inner-box">
                        <figure class="image-box">
                           <img src="{{url('assets/images/gallery/gallary3.png')}}" alt="">
                           <!--Overlay Box-->
                           <div class="caption-box clearfix">
                              <div class="title">
                                <h3>
                   ...
                   <div class="gallery1-item mix all activity video " style="display: inline-block;">
                     <div class="inner-box">
                        <figure class="image-box">
                           <img src="{{url('assets/images/gallery/gallary4.png')}}" alt="">
                           <!--Overlay Box-->
                           <div class="caption-box clearfix">
                              <div class="title">
                                <h3>
