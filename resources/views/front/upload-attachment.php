                    ...
                    <div class="table-responsive ">
                         <table class="table" >
                            <tr>
							  ...
							  <button class="btn btn-default pull-right" >Add Upload Document</button>
							  <input type="file" name="myfile"  class="pull-right" />
							</div>
						</td>
                            </tr>
                         </table>
                        <table class="table table-bordered" border="1"  style="padding: 15px;    background: #fff;box-shadow: aliceblue;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                            ...
                            <tbody>
                                <tr>
                                <td class="text-center"><a href="images/doc.jpg" download><img src="images/doc.jpg" style="max-height: 100px;width: 100px"></a></td>
                                <td class="text-center">Adhar Card</td>
                                <td class="text-center" style="color: #e96036">Pending</td>
                               
                                <td class="text-center">					
                                 <button class="btn btn-s1"><i class="fa fa-pencil"></i> EDIT</button>&nbsp <button class="btn btn-s2"> DELETE</button> </td>
                                </tr>
                                <tr>
                                <td class="text-center"><a href="images/doc.jpg" download><img src="images/doc.jpg" style="max-height: 100px;width: 100px"></a></td>
                                <td class="text-center">Mark sheet</td>
