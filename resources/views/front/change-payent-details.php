                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="table-responsive ">
                        ...
                        <table class="table table-bordered" >
                            ...
                            <tbody>
                                <tr>
                                <td class="text-center"><b>#1234</b><br>Listing id</td>
                                <td class="text-center"> <b>Your Heading</b><br>Your title</td>
                                <td class="text-center"><b>6400 sq.ft.</b><br>Built Up Area</td>
                              
                                <td class="text-center"> <button class="btn btn-s1"><i class="fa fa-pencil"></i> EDIT</button>  </td>
                                </tr>
                                <tr>
                                <td class="text-center"><b>#1234</b><br>Listing id</td>
                                <td class="text-center"> <b>Your Heading</b><br>Your title</td>
