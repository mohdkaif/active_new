                    ...
                    <div class="inner-column">
                        <ul class="contact-info-list">
                            <li>
                                ...
                                <div class="info"><p>Sector 63 <br> Noida </p></div>
                            </li>
                            <li class="active">
                                <div class="title-box"><i class="flaticon-phone-auricular-with-high-volume text-sky"></i>Call Us </div>
                                <div class="info"><p>Support:  +91-000 000 0000 <br> Inquiry:  +91-000 000 0000</p></div>
                            </li>
                            <li>
                                <div class="title-box"><i class="flaticon-black text-orange"></i>Email</div>
                                <div class="info"><p>abc@gamil,com <br> xyz@gmail.com</p></div>
                            </li>
                        </ul>
